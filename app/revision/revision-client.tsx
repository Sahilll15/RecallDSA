...
export default function RevisionPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      ...
      <main className="container relative mx-auto max-w-6xl flex-1 px-4 py-10">
        <motion.header
        ...
        <details className="mt-6 rounded-[var(--radius)] border border-border bg-surface">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3">
            <span>
              <span className="block text-sm font-medium">Advanced queue tools</span>
              <span className="block text-xs text-muted-foreground">
                Use these after the core recall queue is working.
              </span>
            </span>
